  ...
  return (
    <div className={styles.tagline_main}>
      ...
      <div className={styles["right"]}>
        <Image width={640} height={640} src="/graphics.png" alt="Acharea" />
      </div>
    </div>
  );
};
