  ...
  return (
    <div className={styles.tagline_main}>
      ...
      <div className={styles["right"]}>
        <Image width={6400} height={6400} src="/graphics.png" alt="Acharea" />
      </div>
    </div>
  );
};
