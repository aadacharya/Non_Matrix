  ...
  return (
    <div className={styles.footer_main}>
      ...
      <div className={styles.social_medias}>
        <Image width="48" height="48" src="data:image/png;base64," alt='Graphics'/>
        <Image width="48" height="48" src="https://img.icons8.com/fluency/48/facebook-messenger--v2.png" alt="facebook-messenger--v2"/>
        <Image width="48" height="48" src="https://img.icons8.com/fluency/48/instagram-new.png" alt="instagram-new"/>
        <Image width="48" height="48" src="https://img.icons8.com/ios-filled/50/twitterx--v1.png" alt="twitterx--v1"/>
        <Image width="64" height="64" src="https://img.icons8.com/color/48/youtube-play.png" alt="youtube-play"/>
      </div>
        <Image width="48" height="64" src="/Next.svg" alt='Graphics'/>
      </div>
