    ...
    <div>
      ...
      <div className={styles.contactmain}>
        <div className={styles.contact}>
          ...
          <div className={styles.contact_container}>
          <img src="https://img.icons8.com/external-tal-revivo-color-tal-revivo/48/external-viber-logo-with-hand-phone-receiver-under-chat-bubble-logo-color-tal-revivo.png" alt="external-viber-logo-with-hand-phone-receiver-under-chat-bubble-logo-color-tal-revivo"/>
            <p>+977-9802345866</p>
          </div>
          <div className={styles.contact_container}>
